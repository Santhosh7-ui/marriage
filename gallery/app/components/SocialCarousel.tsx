      ...
      <div className={styles.postCard}>
        ...
        <div className={styles.header}>
          <div className={styles.headerLeft}>
            <div className={styles.avatar}>
              ...
              <img src="/api/image?key=favorites/IMG_20240516_201727.jpg" alt="Avatar" onError={(e) => e.currentTarget.src = 'https://i.pravatar.cc/150?u=a042581f4e29026704d'} />
            </div>
        ...
        <div className={styles.footer}>
          <div className={styles.actionRow}>
            ...
            {/* Save Icon */}
            <svg aria-label="Save" onClick={() => setSaved(!saved)} fill={saved ? 'currentColor' : 'none'} height="24" role="img" viewBox="0 0 24 24" width="24">
